        ...
        <div className={`${frame === "month"? "h-screen":""} flex flex-col bg-dark-color text-white pl-[24px]`}>
          ...
          <div className="h-screen w-screen flex overflow-y-scroll no-scrollbar">
            <div className="flex flex-col justify-center">
              <button className="p-4 rounded-lg text-white" style={{backgroundColor: "rgb(0, 188, 212, 0.08)"}}>
              ...
              <button className="p-4 ">
                <svg width="30" height="30" fill="#ffffff" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
