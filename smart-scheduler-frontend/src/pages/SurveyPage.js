...
function generateTimeOptions() {
    ...
    for (let i = 0; i < 96; i++) { // 96 khoảng thời gian 15 phút trong 24 giờ
...
function SurveyPage() {
    ...
    return (
        <div className='Survey__Block' style={{ backgroundImage: 'linear-gradient(to right, #146D78, #1F3336)' }}>
            <div>
                <h1>Survey</h1>
            ...
            <div>
                ...
                <div className="Activity__Block">
                    ...
                    <div className="Activity__Start">
                        <select id="shower-start" >
                            {timeOptions}
                        </select>
                    </div>
                </div>
            </div>
            <Link to="/"><button style={{ backgroundImage: 'linear-gradient(to left, #00717F, #00777F)' }}>Save</button></Link>
        </div>
    );
}
